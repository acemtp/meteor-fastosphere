...
algolia = new AlgoliaSearch(Meteor.settings.public.algolia_application_id, Meteor.settings.public.algolia_public_id, {dsn: true, tld: 'net'});
index = algolia.initIndex('PackagesTest');
